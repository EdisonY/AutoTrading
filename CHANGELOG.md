...
- Not completed / remaining: Tencent/Aliyun SQLite snapshot now passes integrity checks, but the mirrored DB logical file size is about 1.29GB again after fresh backup; follow-up should inspect page/freelist growth and ensure cleanup/VACUUM policy keeps the file compact without blocking live services.
