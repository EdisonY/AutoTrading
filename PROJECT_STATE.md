...
- 2026-06-01 update: the same API guard now also enforces `BINANCE_API_GUARD_MAX_REQUESTS_PER_MIN` (default `120/min`) across all live processes and reports `rolling_count_60s/top_paths_60s` to system alerts.
