...
- A/v11 approved trailing-pullback rollout is the current P1 rollback-watch. Next review should compare 24h/72h/168h real PnL, forced-close contribution, regime context, and whether the selected `15m=1.0 ATR` / `30m=0.8 ATR` values should continue, narrow, or roll back.
