...
STRONG_SIGNAL_THRESHOLD = 105  # 反事实评估后放宽: 满仓时强信号可释放弱仓
EVICT_SOFT_PROTECT_PNL_PCT = 2.0  # 小盈利仓只在新信号明显更强时释放
EVICT_HARD_PROTECT_PNL_PCT = 6.0  # 大盈利仓硬保护，不参与释放
...
EVICT_SCORE_GAP = 12          # 新信号至少比弱仓入场分高12分
EVICT_SOFT_PROTECT_SCORE_GAP = 24
...
class Scanner:
    ...
    def _release_position_for_strong_signal(
        ...
        trade = {
            ...
            "replacement_policy": "counterfactual_v1",
        }
