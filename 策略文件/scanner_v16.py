    ...
    def _can_open_new_position(self, risk_usdt, tf, sym, side, score, return_cases=False):
        ...
        if scanner_paper_execution_enabled():
            ...
            state_case = strategy_gate_case(
                name="b_v16_paper_account_state_available",
            ...
            decision = self.risk_engine.check_entry(
                ...
                side_positions=sum(1 for tf_pos in self.positions.values() for pos in tf_pos.values() if pos.side == side),
            ...
            risk_case = strategy_gate_case(
                ...
                decision=risk_gate,
                meta={"strategy": "B/v16", "timeframe": tf, "paper_execution": True},
            )
