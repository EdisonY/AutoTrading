...
3. **P1-C 完整 replay/fill 引擎**
   ...
   - 未完成：A/v11 rollout/recovery comparison 仍受本地/镜像 Kline cache 覆盖限制，长历史 Kline 窗口、order-book depth/queue-priority fill simulation 和 governance 仍未完成；当前 partial-fill 是 cap 近似，不是真实深度撮合。
