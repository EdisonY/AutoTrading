...
1. **P0-A Binance API 根治**
   ...
   - 未完成：user-data-stream/central account-state、跨操作 open/close confirmation 状态服务、独立 API 队列服务、当前 public cooldown 到 `2026-06-02T23:12:59+08:00` 后的 quiet/recovery 观察，以及连续 30 分钟无新 418/429/-1003。
