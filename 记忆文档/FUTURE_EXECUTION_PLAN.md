...
- [ ] Post-launch staged restoration: restore system-alerts/account-snapshot/cache/sentinel/scanners/data-maintenance in controlled order with queue/cooldown checks between steps. P0-B open/close natural exact rows and P0-A longer normal-universe observation remain post-launch evidence collection and must not block first-version skeleton landing.
