...
1. **P0-A Binance API 根治**
   ...
   - 未完成：user-data-stream websocket transport、scanner/client 正式接入独立 API 队列、open/close confirmation 状态服务完全替代 REST、中心 account-state service fresh-run 验证，以及连续 30 分钟无新 418/429/-1003。当前 Tencent Testnet 服务已暂停，不应把 paused 状态当作 P0-A 验收通过。
