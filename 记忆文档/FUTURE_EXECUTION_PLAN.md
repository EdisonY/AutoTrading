...
- [ ] Remaining P1-B/P1-D: wait for enough post-refresh samples, then review full paper fill/slippage simulation including hard-bottom/profit-retrace guard parity, mature PF/cost/failure evidence, and rollback-plan governance before any manual continue/narrow/rollback decision.
