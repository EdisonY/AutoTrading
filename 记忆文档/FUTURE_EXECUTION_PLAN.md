...
- [ ] Remaining P1-C/P1-E: true staged Kline backfill to 30+ day acceptance, staged depth sampling coverage, post-ingest rollout/recovery replay review on real long-history partitions, and a real queue-priority/market-impact engine beyond current static assumptions.
