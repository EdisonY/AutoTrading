...
- [ ] Remaining P0-B: expand scanner exact-case coverage to threshold/confirmation/score/cooldown/pre-filter paths, then expand event-driven same-input replay/live checks beyond single pure gates into orchestration context.
