...
- [ ] Remaining P0-B: expand scanner exact-case coverage to A/v11 threshold/pre-filter and B/C pre-filter/cooldown/score paths where they enter audited event rows, then expand event-driven same-input replay/live checks beyond single pure gates into orchestration context.
