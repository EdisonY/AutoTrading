...
- [ ] Remaining P1-C/P1-E: A/v11 rollout/recovery long-history bar-by-bar coverage, true 30+ day Kline backfill source, depth snapshot producer/warehouse, and queue-priority/market-impact simulation beyond conservative visible-depth assumptions.
