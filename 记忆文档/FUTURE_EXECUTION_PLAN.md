...
- [ ] Remaining P1-C/P1-E: A/v11 rollout/recovery long-history bar-by-bar coverage, true staged Kline backfill to 30+ day acceptance, staged depth sampling coverage, and queue-priority/market-impact simulation beyond conservative visible-depth assumptions.
