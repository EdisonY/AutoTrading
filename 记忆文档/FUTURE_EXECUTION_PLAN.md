...
- [ ] Remaining first-version hard gates: P0-A staged clean run, P0-B fresh exact-case parity evidence from post-instrumentation rows, then final dirty-data archive/reset and fresh zero-run. B/v16 and C/v14 scanner staged validation are next after the public cooldown clears.
