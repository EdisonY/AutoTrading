...
- [ ] Remaining P0-B: make live scanners persist more exact `strategy_gate_case(s)`, then expand event-driven same-input replay/live checks beyond single pure gates into orchestration context.
