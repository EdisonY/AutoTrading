...
- [ ] 下一轮并行记录：J3 暂停参数拟合，只保留 range-chop/突破结构线索；X7/K2/L1 只保留结构线索；4h breadth watchlist、K2 `high_vol_chop_v2`、L1 negative-jump bounce 只能作为后续预注册 context/filter clue，不能直接 paper/live。
