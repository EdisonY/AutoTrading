...
- [ ] Post-launch staged restoration layer 3a: deploy/use per-account account-state baseline, then refresh A, B, and C one at a time with queue/cooldown checks between each signed baseline.
