...
1. **P0-A Binance API 根治**
   ...
   - 未完成：scanner/sentinel/market-data-cache 仍未进入新队列+中心状态体系下的谨慎 clean fresh-run。当前 Tencent Testnet trading/scanning/reporting loops 仍暂停；API queue + user-stream-only clean 观察窗口需至少到 `2026-06-03 05:17 +08` 后才可考虑下一步。
