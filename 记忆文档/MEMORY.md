...
- P0-B 第一段已开始：新增 `core/strategy_gates.py`，把 B/v16 entry-threshold gate 与 15m confirmation gate 抽成 pure function，B/v16 live scanner 直接调用。等价 smoke 覆盖代表性阈值/确认场景，部署 `20260602-183952-strategy-b-ecadb79` 后 B/v16 active 且无 import/限流新错误。后续继续抽 A/v11、C/v14 和 B/v16 剩余 risk/position/execution gates，并做同输入 parity test。
