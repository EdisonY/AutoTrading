...
- 2026-06-01：受控扩样可视化继续推进。`strategy_evolution_gate.py` 新增 `expansion_readiness`，把已全量放开的候选按 24h post-approval 窗口汇总成熟/继续收样/暂停复核、样本缺口和每候选动作；`portal_dashboard.py` 第一屏直接显示“扩样成熟度”，用于判断继续收样还是暂停扩张。
