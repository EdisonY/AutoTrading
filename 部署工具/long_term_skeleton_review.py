...
DEFAULT_SPECS: list[dict[str, Any]] = [
    ...
    module_spec(
        ...
        main=[
            ...
            bone("auto upgrade readiness guard", "部署工具/auto_upgrade_readiness.py"),
        ],
        outputs=[
            ...
            bone("auto upgrade readiness output", "部署工具/auto_upgrade_readiness.py", contains="auto_upgrade_readiness_latest"),
        ],
        portal=[
            bone("rollback portal sections", "部署工具/portal_dashboard.py", contains="ROLLBACK_AUTOMATION_JSON"),
            bone("auto upgrade portal section", "部署工具/portal_dashboard.py", contains="AUTO_UPGRADE_READINESS_JSON"),
        ],
        sync=[
            bone("Aliyun refresh rollback chain", "部署工具/aliyun_analysis_refresh.sh", contains="rollback_automation_guard.py"),
            bone("Aliyun refresh upgrade chain", "部署工具/aliyun_analysis_refresh.sh", contains="auto_upgrade_readiness.py"),
            bone("reverse sync rollback chain", "部署工具/sync_aliyun_reports_to_tencent.py", contains="rollback_automation_guard_latest"),
            bone("reverse sync upgrade chain", "部署工具/sync_aliyun_reports_to_tencent.py", contains="auto_upgrade_readiness_latest"),
            bone("live-context rollback chain", "部署工具/pull_live_context.py", contains="rollback_automation_guard_latest"),
            bone("live-context upgrade chain", "部署工具/pull_live_context.py", contains="auto_upgrade_readiness_latest"),
        ],
        tests=[
            ...
            bone("auto upgrade readiness tests", "tests/test_auto_upgrade_readiness.py"),
        ],
        validation_blockers=[],
