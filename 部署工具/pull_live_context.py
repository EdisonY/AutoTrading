...
MAIN_FILES = [
    ...
    ("reports/research_store_compaction_latest.md", "reports/research_store_compaction_latest.md", False),
    ...
    ("reports/replay_live_parity_latest.md", "reports/replay_live_parity_latest.md", False),
    ("reports/replay_readiness_latest.md", "reports/replay_readiness_latest.md", False),
    ("reports/waiting_period_optimization_latest.md", "reports/waiting_period_optimization_latest.md", False),
    ("reports/waiting_period_optimization_latest.html", "reports/waiting_period_optimization_latest.html", False),
    ("reports/long_term_skeleton_latest.md", "reports/long_term_skeleton_latest.md", False),
    ...
    ("reports/strategy_candidate_governance_latest.md", "reports/strategy_candidate_governance_latest.md", False),
    ("reports/waiting_period_progress_latest.md", "reports/waiting_period_progress_latest.md", False),
    ("reports/paper_real_calibration_plan_latest.md", "reports/paper_real_calibration_plan_latest.md", False),
    ...
    ("runtime/research_store_compaction_latest.json", "runtime/research_store_compaction_latest.json", False),
    ...
    ("runtime/strategy_candidate_governance_latest.json", "runtime/strategy_candidate_governance_latest.json", False),
    ("runtime/waiting_period_progress_latest.json", "runtime/waiting_period_progress_latest.json", False),
    ("runtime/paper_real_calibration_plan_latest.json", "runtime/paper_real_calibration_plan_latest.json", False),
...
services = {
    ...
    for name in (
        ...
        "crypto-historical-kline-incremental.timer",
        "crypto-historical-kline-incremental.service",
    )
}
...
print(json.dumps({
    ...
    "strategy_candidate_governance_summary": {
        "status": candidate_governance.get("status"),
        "automatic_upgrade_allowed": candidate_governance.get("automatic_upgrade_allowed"),
        "apply_enabled": candidate_governance.get("apply_enabled"),
        "summary": candidate_governance.get("summary", {}),
        "lifecycle_summary": candidate_governance.get("lifecycle_summary", {}),
    },
    "waiting_period_progress_summary": {
        "status": waiting_progress.get("status"),
    ...
    "historical_kline_backfill_summary": {
        ...
        "quality": historical_kline.get("quality", {}),
        "universe_size": len((historical_kline.get("universe") or {}).get("symbols") or []),
    },
    "historical_kline_incremental_summary": {
        "status": historical_kline_incremental.get("status"),
        "mode": historical_kline_incremental.get("mode"),
        "apply_enabled": historical_kline_incremental.get("apply_enabled"),
        "live_scanner_impact": historical_kline_incremental.get("live_scanner_impact"),
        "binance_requests_enabled": historical_kline_incremental.get("binance_requests_enabled"),
        "strategy_frequency_change": historical_kline_incremental.get("strategy_frequency_change"),
        "config": historical_kline_incremental.get("config", {}),
